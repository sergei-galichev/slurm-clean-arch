...
func (x *GroupResponse) GetModifiedAt() *timestamp.Timestamp {
	if x != nil {
		return x.ModifiedAt
	}
	return nil
...
var file_contact_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf1, 0x01, 0x0a, 0x0d, 0x47, 0x72,
	...
	0x6f, 0x64, 0x69, 0x66, 0x69, 0x65, 0x64, 0x41, 0x74, 0x12, 0x22, 0x0a, 0x0c, 0x63, 0x6f, 0x6e,
	0x74, 0x61, 0x63, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x0c, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x69, 0x0a,
	...
	0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x49, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61,
...
var file_contact_proto_goTypes = []interface{}{
	(*GroupResponse)(nil),       // 0: contact.GroupResponse
	(*CreateGroupRequest)(nil),  // 1: contact.CreateGroupRequest
...
var file_contact_proto_depIdxs = []int32{
	...
	0, // 2: contact.CreateGroupResponse.response:type_name -> contact.GroupResponse
	0, // 3: contact.UpdateGroupResponse.response:type_name -> contact.GroupResponse
	0, // 4: contact.DeleteGroupResponse.response:type_name -> contact.GroupResponse
	1, // 5: contact.ContactService.CreateGroup:input_type -> contact.CreateGroupRequest
